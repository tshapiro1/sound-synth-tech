{
    "patcher": {
        ...
        "classnamespace": "box",
        "rect": [ 1675.0, 357.0, 1597.0, 951.0 ],
        "boxes": [
            {
                "box": {
                    "id": "obj-16",
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 273.7288200855255, 60.0, 74.0, 22.0 ],
                    "text": "receive~ in1"
                }
            },
            {
            ...
            {
                "box": {
                    "addpoints": [ 0.5294220230796121, 256.47051334381104, 0, 32.4385020082647, 536.470513343811, 0, 52.483967477625065, 846.470513343811, 0, 81.0, 226.47051334381104, 0 ],
                    "classic_curve": 1,
                    "domain": 81.0,
                    "id": "obj-81",
                    "maxclass": "function",
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 395.50848603248596, 367.0, 201.0, 48.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "parameter_enable": 0,
                    "patching_rect": [ 22.38805890083313, 595.0, 280.0, 80.0 ]
                }
            },
            {
                "box": {
