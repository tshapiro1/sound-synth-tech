        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 473.0, 196.0, 185.0, 22.0 ],
                    "text": "50 100 150 200 300 400 600 800"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 674.0, 127.0, 40.0, 22.0 ],
                    "text": "size 8"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 695.0, 176.0, 177.0, 80.0 ],
                    "setminmax": [ 0.0, 1.0 ],
                    "setstyle": 1,
                    "size": 8
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 473.0, 134.0, 54.0, 22.0 ],
                    "text": "t b b b"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 731.0, 141.0, 37.0, 22.0 ],
                    "text": "fetch"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 255.0, 200.0, 177.0, 49.0 ],
                    "setminmax": [ 0.0, 1.0 ],
                    "setstyle": 1,
                    "size": 8
                }
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 264.5, 246.0, 210.0, 246.0, 210.0, 180.0, 153.1247371037801, 180.0 ],
                    "source": [ "obj-40", 0 ]
                }
            },
            {
